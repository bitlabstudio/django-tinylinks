...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tinylink.amount_of_views'
        db.add_column('tinylinks_tinylink', 'amount_of_views',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tinylink.amount_of_views'
        db.delete_column('tinylinks_tinylink', 'amount_of_views')
