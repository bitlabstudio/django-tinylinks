...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tinylink.user'
        db.add_column('tinylinks_tinylink', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm[user_orm_label]),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tinylink.user'
        db.delete_column('tinylinks_tinylink', 'user_id')
